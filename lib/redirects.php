...
if (!class_exists("Simple301redirects")) {
	...
	class Simple301Redirects {
		...
		function create_menu() {
		  add_menu_page('301 Redirects', '301 Redirects', 'manage_options', '301options', array($this,'options_page'), 'dashicons-admin-links', 4);
		}
		...
		?>
			...
			<h2>Little Monsters Theme Options: 301 Redirects</h2>
